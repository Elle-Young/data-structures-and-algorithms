...
const citiesAtoJ = (arr) => {
  let regEx = /[A|B|C|D|E]/g
  let newCities = myArr.match(regEx);
};
...
const matchMonth = (input) => {
  let answer = ['October', 'Oct', 'oct', 'october'];
  let regEx = \(input)\g;

  if input
    //if input is a string that matches answer[i] then my regEx output will be true. Otherwise Regex output is false.
